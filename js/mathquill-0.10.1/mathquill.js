...
function getInterface(v) {
  ...
  APIClasses.EditableField = P(AbstractMathQuill, function(_, super_) {
	...
	_.moveToNodeById = function(dir, nodeId){
	  var node = nodeId ? Node.byId[nodeId] : this.__controller.root;
	  this.__controller.notify('move').cursor.insDirOf(dir, node);
	  return this;
	}
